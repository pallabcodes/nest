...
export class NeatTypeORMModule {
        ...
        providers: [
            ...
            // Auto-setup database connection
            {
                ...
                useFactory: () => {
                    ...
                    const config = {
                        driver: 'sqlite', // TODO: Fix branded type
            ...
            // Auto-create entity manager
            {
                ...
                useFactory: async (connection, entities) => {
            ...
            // Auto-create repositories for all entities
            {
                ...
                useFactory: (entityManager, entities) => {
     ...
     */
    static configure(config, entities) {
        return {
            module: NeatTypeORMModule,
            providers: [
 ...
 * ```
 */
export const entityRegistry = new Set();
 ...
 */
export function createConventionConfig() {
    return {
...
//# sourceMappingURL=neat-typeorm.module.js.map