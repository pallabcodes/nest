 ...
 * Based on passport-google-oauth20 profile structure
 */
...
declare global {
  namespace Express {
    interface Request {
      ...
      /** Raw body buffer (for webhook verification) */
      rawBody?: Buffer;
      /** Parsed cookies */
      cookies?: Record<string, string>;
      /** Parsed signed cookies */
      signedCookies?: Record<string, string>;
    }

    interface Response {
      /** Custom response method for API responses */
      apiResponse?: <T>(data: T, message?: string, statusCode?: number) => Response;
      /** Custom response method for paginated responses */
      paginatedResponse?: <T>(
        data: T[],
