...
export class FindAllStudentQueryDto {
  @ApiProperty({ example: 'John', description: 'Filter by student name', required: false })
  @IsOptional()
  @IsString()
  name?: string;

  @ApiProperty({ example: 'john@example.com', description: 'Filter by student email', required: false })
  @IsOptional()
  @IsString()
  email?: string;
