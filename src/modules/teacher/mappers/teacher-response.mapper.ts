...
/**
 * TeacherResponseMapper
 *
 * Maps teacher-related domain entities/DTOs to API response format.
 */
@Injectable()
export class TeacherResponseMapper extends BaseResponseMapper<any, any> {
  /**
